...
def lambda_handler(event, context):
    ...
    if artificial_delay_ms > 0:
        print(f'[Transform] Applying artificial delay: {artificial_delay_ms}ms')
    ...
    print(f'[Transform] COMPLETE - Compute: {compute_time:.0f}ms, Delay: {artificial_delay_ms}ms, Total: {total_time:.0f}ms')
